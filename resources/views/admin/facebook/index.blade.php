...
@section('content')
    ...
    @if(Session::has('facebook_message'))
        <p class="alert alert-info my-3">{{session('facebook_message')}}</p>
    @endif
            ...
            @foreach($facebook as $user)
                <tr>
                    ...
                    <td>
                            ...
                            <a class="btn btn-warning" href="{{route('admin.facebookRestore', $user->id)}}">Restore</a>
                            @else
                            {!! Form::open(['method'=>'DELETE',
                            'action'=>['App\Http\Controllers\AdminFacebookController@destroy', $user->id]]) !!}
